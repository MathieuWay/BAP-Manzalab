...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class BoxChoice : MonoBehaviour
    {
        ...
        /// <summary>
        /// a game object parenting UI for display Questions for assistance.
        /// </summary>
        public GameObject QuestionAssistance;

        public GameObject QuestionAssistance2;

        /// <summary>
        /// The rotation in degrees need to apply to model when the Andy model is placed.
        /// </summary>
        private float k_ModelRotation =0.0f;

        ///bool for know if the box is install or not
        private bool boxposer = false;

        private bool showQuestionUI = false;
